...
export async function POST(
  ...
  try {
    ...
    const newClientConfirmed = isClient ? true : appointment.clientConfirmed
    const newProfessionalConfirmed = isProfessional ? true : appointment.professionalConfirmed
    const bothConfirmed = newClientConfirmed && newProfessionalConfirmed
